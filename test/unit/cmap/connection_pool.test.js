...
describe('Connection Pool', function () {
  ...
  describe('#waitQueueErrorMetrics', function () {
    ...
    it.only('returns the metrics information for the pool', function () {
  ...
  describe('#markPinned', function () {
    ...
    it.only('sets the metrics information for the pool', function () {
      expect(pool.waitQueueErrorMetrics()).to.equal(
        `maxPoolSize: 1, ` +
    ...
    it.only('sets the pin type on the connection', function () {
